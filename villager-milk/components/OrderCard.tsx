        ...
        <View className="bg-white rounded-xl p-3 mt-3 shadow-sm border border-gray-100">
                ...
                <View className="flex-1 flex-row justify-between  ">
                    <View className="flex-col justify-around gap-4 ">
                        ...
                        <View className="flex-row gap-3 items-center">
                            ...
                            <Text className="text-sm font-bold text-[#0E7490]">
                                ₹{product.price}
                            </Text>
                        </View>
                    </View>

                    <View className="flex-col justify-center items-center  mt-0.5">
                        <QuantitySelector
                            quantity={1}
            ...
            <View className="flex-row justify-between">
                <View className="flex-row items-center gap-1">
                    ...
                    <Text className="text-[11px] text-gray-600">Start: 10/05</Text>
                </View>

                <View className="flex-row items-center gap-1">
                    <Calendar size={14} color="#F98E6C" />
                    <Text className="text-[11px] text-gray-600">End: 10/05</Text>
                </View>
            </View>
        </View>
    );
